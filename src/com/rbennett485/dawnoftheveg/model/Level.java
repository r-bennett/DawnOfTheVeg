...
/**
 * Stores the data which defines a level - the waypoints for the enemies, the
 * positions of the tower patches, and the waves of enemies
 * 
...
public abstract class Level {
	 ...
	 * 
	 * @param INITIAL_MONEY
	 *            - the sum of money at the start of the level
	 * @param background
	 *            - the texture to which the level background belongs
	 * @param backgroundRegion
	 *            - the texture region for the level background
	 */
	public Level(int INITIAL_MONEY, Texture background,
