...
/**
 * Represents splats in the game's model (used when an enemy has died)
 * 
...
public class Splat extends GameObject {
	 ...
	 * 
	 * @param e
	 *            The enemy from which the splat copies its colour, position and
	 *            size
	 */
	 ...
	 * 
	 * @param deltaTime
	 *            Seconds elapsed since last updated
	 */
